      ...
      <div class="col-md-5">
        ...
        <form method="POST" action="{{ route('mypage') }}">
          ...
          <div class="form-group">
            ...
            <div class="show editUserName collapse">
          ...
          <div class="form-group">
            ...
            <div class="show editUserMail collapse">
          ...
          <div class="form-group">
            ...
            <div class="show editUserPhone collapse">
              <input id="postal_code" type="text" class="form-control @error('postal_code') is-invalid @enderror"
                name="postalCode" value="{{ $user->postal_code }}" required autocomplete="postal_code" autofocus
          ...
          <hr>
          <button type="submit" class="btn samuraimart-submit-button w-25 mt-3">
            保存
          </button>
        </form>
      </div>
